...
`docs/features/catalog/003-2026-07-30-taxonomia-centralizada.md` y `docs/features/platform/002-2026-07-30-datos-de-prueba-e2e.md`, más los defectos que
...
> **2026-07-31.** Se entregó el slice 1 de `docs/features/commerce/001-2026-07-31-vendedores-y-tiendas.md` (alta de vendedor y
> página pública `/tienda/<handle>`). La base compartida subió a Alembic `0027`. El detalle está en
> `docs/features/commerce/001-2026-07-31-vendedores-y-tiendas-bitacora.md`; lo de abajo sigue vigente salvo donde se indica.
...
No requiere código. El orden está en `docs/features/catalog/003-2026-07-30-taxonomia-centralizada.md`, sección "Orden de
...
El slice está especificado en `docs/features/platform/002-2026-07-30-datos-de-prueba-e2e.md`. Lo esencial:
