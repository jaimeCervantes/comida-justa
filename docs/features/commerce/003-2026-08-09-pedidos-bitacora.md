...
Append-only. El roadmap y los criterios de aceptación viven en `docs/features/commerce/003-2026-08-09-pedidos.md`.
...
### De paso: `docs/data/001-2026-06-19-database.md`
...
`docs/planning/001-2026-07-30-pendientes.md`.
...
diagnosticado en `docs/planning/001-2026-07-30-pendientes.md`.
...
4. **Hay un `<main>` dentro de otro `<main>` en 21 rutas.** El layout ya pinta el landmark y las
   ...
   arregló**: son 21 archivos de rutas ajenas a esta feature. Queda con receta en `docs/planning/001-2026-07-30-pendientes.md`.
...
2. **El `<main>` anidado en 21 rutas**, con la receta ya escrita en `docs/planning/001-2026-07-30-pendientes.md`.
