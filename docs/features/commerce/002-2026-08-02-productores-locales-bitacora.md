...
`docs/features/commerce/002-2026-08-02-productores-locales.md` quedó reescrito antes de la primera línea de implementación.
...
- **Roadmap y especificación:** `docs/features/commerce/002-2026-08-02-productores-locales.md`,
...
- **Bitácora:** `docs/features/commerce/002-2026-08-02-productores-locales-bitacora.md`.
...
`docs/features/planning/001-2026-08-07-pendientes.md` mostró además que, cuando la acción sí llegaba, el remontaje perdía su
