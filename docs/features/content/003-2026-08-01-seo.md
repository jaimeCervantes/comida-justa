...
`docs/features/content/003-2026-08-01-seo-bitacora.md`.
...
> con `hreflang` y el sitemap lista las dos direcciones. Ver `docs/features/content/002-2026-08-01-i18n-bitacora.md`.
