...
`docs/features/community/001-2026-08-02-secciones-comunidad.md` dice qué es cada sección, cuál se resuelve con lo que ya
...
- **Docs:** `docs/features/community/001-2026-08-02-secciones-comunidad.md` (el plan completo de las seis).
...
- Los cinco slices siguientes están en `docs/features/community/001-2026-08-02-secciones-comunidad.md`. El próximo sin
