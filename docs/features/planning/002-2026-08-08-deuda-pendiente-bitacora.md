...
### 2. `docs/data/001-2026-06-19-database.md` describía una base que no existe
...
**Documentos**
- `docs/data/001-2026-06-19-database.md` — reescrito contra el esquema real.
- `docs/features/planning/001-2026-08-07-pendientes.md` — cinco entradas cerradas, la de `rounded-*` con su cuenta real.
...
defectos corregidos; `docs/data/001-2026-06-19-database.md` describe la base que existe; el mapa pasa por el design
