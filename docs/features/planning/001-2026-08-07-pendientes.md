...
Los cuatro slices están entregados (`docs/features/search/003-2026-08-07-busqueda-semantica.md` + bitácora): texto
completo, respaldo de idioma, rescate semántico y medición. Encima va
`docs/features/search/002-2026-08-07-busqueda-entre-idiomas.md`, que quitó el filtro de idioma de la consulta.
...
Slices 0–4 hechos. Ver `docs/features/content/002-2026-08-01-i18n.md` y su bitácora.
...
- ~~**`docs/data/001-2026-06-19-database.md` está desactualizado**~~ — **reescrito el 2026-08-08** contra el esquema
...
Slices 1–9 hechos. Ver `docs/features/platform/001-2026-07-28-design-system.md` y su bitácora.
