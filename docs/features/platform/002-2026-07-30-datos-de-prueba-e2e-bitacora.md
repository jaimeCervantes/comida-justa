...
Append-only. Roadmap en `docs/features/platform/002-2026-07-30-datos-de-prueba-e2e.md`.
...
- `docs/features/platform/002-2026-07-30-datos-de-prueba-e2e.md` y `src/e2e/testData/testData.feature` *(nuevos)*
...
[`docs/planning/001-2026-07-30-pendientes.md`](../../planning/001-2026-07-30-pendientes.md).
