...
Registro append-only por slice. El roadmap vive en `docs/features/catalog/002-2026-07-25-catalogo-unificado.md`.
...
- `docs/features/catalog/002-2026-07-25-catalogo-unificado.md` (estados de slices)
