...
const meta = {
  ...
  argTypes: {
    media: {
      control: 'object',
      description: 'Objeto que define el tipo de medio, URL y texto alternativo',
    },
    className: {
      control: 'text',
...
export const Video: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(videoElement).toHaveAttribute('src', 'https://example.com/sample-video.mp4');
...
export const Image: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(imageElement).toHaveAttribute('src', expect.stringContaining('/sample-image.jpg'));
...
export const Audio: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(audioElement).toHaveAttribute('src', 'https://example.com/sample-audio.mp3');
...
export const Default: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(linkElement).toHaveAttribute('href', 'https://example.com/sample-document.pdf');
...
export const UnknownType: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(linkElement).toHaveAttribute('href', 'https://example.com/unknown-file.xyz');
  }
};
...
export const EmptyAltText: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(linkElement).toHaveAttribute('href', 'https://example.com/empty-alt-file.pdf');
  }
};