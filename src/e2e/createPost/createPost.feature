Feature: Create Post
  Let users create a new post of healthy post

  As an registered user
  I want to create a new post
  So that I can sell healthy post

  Scenario: Anonymous User trying to publish a post
    Given a unregistered User that opened the app
    When this anonymous user wants to publish a healthy post
  ...
  Scenario: Create Post using a Form
    ...
    When this user wants to create a post of healthy post
    Then a Post form should be shown
    When this user enters the title
    And enters description
    And enters price
    And enters images about the post
