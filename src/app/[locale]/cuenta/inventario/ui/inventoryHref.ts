 ...
 *
 * Cambiar de ámbito vuelve a la página 1 salvo que la página venga en el cambio: quien filtra por
 * agotados desde la página 7 de «todos» no quiere la página 7 de una lista que puede tener una.
 * Es la misma regla que ya sigue `ordersHref`, por el mismo motivo.
 */
