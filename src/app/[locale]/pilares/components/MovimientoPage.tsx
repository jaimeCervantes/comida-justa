      ...
      <div className="space-y-8 text-lg text-slate-800 dark:text-slate-200 leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-700 dark:text-slate-300 text-base break-all">
            <li>
              <a
                href="https://doi.org/10.4082/kjfm.24.0099"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1002/dmrr.2759"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.54289/jcrmh2300131"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.3389/fpubh.2022.1042413"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1007/s00125-015-3624-6"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1002/hpm.3070"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1016/j.smhs.2019.08.006"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.70102/aej.2025.17.3.34"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1123/jpah.2019-0377"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1136/bjsports-2013-093107"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1016/j.eclinm.2022.101424"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.3389/fpubh.2024.1358423"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.7326/m14-1651"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1016/j.pcad.2019.02.004"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1016/j.artere.2019.04.001"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.7326/m14-2552"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1123/jpah.2012-0423"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.1007/s12603-019-1298-3"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
            ...
            <li>
              <a
                href="https://doi.org/10.37268/mjphm/vol.23/no.1/art.1816"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 underline transition-colors"
              >
