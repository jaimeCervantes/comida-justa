...
export default async function NotFound() {
  ...
  return (
    ...
    <section className="flex flex-col justify-center gap-4 items-center">
      <h1 className="text-2xl md:text-3xl font-bold">¡Recurso no encontrado!</h1>

      <h2 className="text-xl md:text-2xl font-bold hidden md:block">Probablemente se fue a hacer una serie extra de burpees... ¡y se agotó!</h2>

      <h3 className="text-lg md:text-xl font-bold">A veces, incluso un recurso necesita un descanso.</h3>
